...
Live at [bruhcode.vercel.app](https://bruhcode.vercel.app)
...
**Registry Management**
- Add and remove members with name, title, experience level, domain, and skills
- Upload member avatars directly from device
- CV upload support (PDF/DOCX) for auto-population of member details
- Full registry export as CSV

**Skill Map**
- Visual breakdown of team skills across 7 domains
- Filter by domain: Web Dev, Mobile Apps, UI/UX, AI/ML, DevOps, Data, QA
...
- AI matches the most relevant team members
